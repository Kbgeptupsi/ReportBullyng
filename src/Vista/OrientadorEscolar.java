 ...
 * @author kristian--
 */
public class OrientadorEscolar extends javax.swing.JFrame {

    /**
     * Creates new form OrientadorEscolar
     */
    public OrientadorEscolar() {
        initComponents();
        CargarTabla();
    }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO Orientadores (Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Activo) VALUES (?,?,?,?,?,?,?,?,?);");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("UPDATE Orientadores SET  Nombres=?,Apellidos=?,Documento=?,Tipo_identificacion=?,Direccion=?,Tipo_sangre=?,Sexo=?,Telefono=?,Activo=? WHERE Id=?");
            ps.setString(1, Nombres);
            ps.setString(2, Apellidos);
            ps.setString(3, Documento);
            ps.setString(4, TipodeIdentificacion);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("DELETE FROM Orientadores WHERE Id=?");
            ps.setInt(1,id);
            ps.executeUpdate();
    ...
    private void tblCoordinadoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCoordinadoresMouseClicked
        try{
            ...
            ResultSet rs;
            Connection con = Conexion.getConexion();
            ps = con.prepareStatement("SELECT Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Activo FROM Orientadores WHERE Id=?");
            ps.setInt(1, id);
            rs= ps.executeQuery();
            while(rs.next()){
       ...
       private void CargarTabla() {
        ...
        try{
            Connection con = Conexion.getConexion();
             ps = con.prepareStatement("SELECT Id,Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Activo FROM Orientadores");
            rs= ps.executeQuery();
            rsmd = rs.getMetaData();
...
txtId.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrientadorEscolar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrientadorEscolar().setVisible(true);
            }
        });
    }
