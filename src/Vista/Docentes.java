...
public class Docentes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ckDG = new javax.swing.JCheckBox();
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        Boolean Director_de_grupo = ckDG.isSelected();
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("INSERT INTO Docentes (Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Director_de_grupo) VALUES (?,?,?,?,?,?,?,?,?);");
            ...
            ps.setBoolean(9, Director_de_grupo);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null,"Docentes Guardado");
            // CargarTabla();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("UPDATE Docentes SET  Nombres=?,Apellidos=?,Documento=?,Tipo_identificacion=?,Direccion=?,Tipo_sangre=?,Sexo=?,Telefono=?,Director_de_grupo=? WHERE Id=?");
            ps.setString(1, Nombres);
            ps.setString(2, Apellidos);
            ps.setString(3, Documento);
            ps.setString(4, TipodeIdentificacion);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("DELETE FROM Docentes WHERE Id=?");
            ps.setInt(1,id);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null,"Docentes Eliminado");
            CargarTabla();
            Limpiar();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null,e.toString());
    ...
    private void tblCoordinadoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCoordinadoresMouseClicked
        try{
            ...
            ResultSet rs;
            Connection con = Conexion.getConexion();
            ps = con.prepareStatement("SELECT Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Director_de_grupo FROM Docentes WHERE Id=?");
            ps.setInt(1, id);
            rs= ps.executeQuery();
            while(rs.next()){
       ...
       private void CargarTabla() {
        ...
        try{
            Connection con = Conexion.getConexion();
             ps = con.prepareStatement("SELECT Id,Nombres,Apellidos,Documento,Tipo_identificacion,Direccion,Tipo_sangre,Sexo,Telefono,Director_de_grupo FROM Docentes");
            rs= ps.executeQuery();
            rsmd = rs.getMetaData();
...
txtId.setText("");
    ...
    private javax.swing.JCheckBox ckDG;
